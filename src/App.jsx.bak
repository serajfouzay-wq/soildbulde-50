      ...
      <div style={{ minHeight:"100vh", background:T.beige, display:"flex", flexDirection:"column", alignItems:"center", padding:"90px 24px 40px" }}>
        <div id="rsvp-card-print" style={{ background:`linear-gradient(160deg, #FCF8F0 0%, #F5EFE3 55%, #EFE6D4 100%)`, borderRadius:24, padding:"clamp(20px,5vw,48px) clamp(16px,5vw,40px)", maxWidth:520, width:"100%", border:`2px solid rgba(184,134,11,0.55)`, boxShadow:"0 24px 60px rgba(92,61,30,0.16)", position:"relative", overflow:"hidden", animation:"cardReveal 0.8s ease-out" }}>
          ...
          <div style={{ textAlign:"center", position:"relative" }}>
            ...
            <h2 style={{ fontFamily:"'Playfair Display',serif", fontSize:28, color:"#B8860B", marginBottom:10, fontWeight:700 }}>{confirmed.name}</h2>
            {confirmed.type==="vip" && confirmed.guestType && (
              <div style={{ display:"inline-block", background:"rgba(184,134,11,0.14)", border:"1px solid rgba(212,175,55,0.4)", borderRadius:20, padding:"3px 14px", marginBottom:12 }}>
                <span style={{ fontFamily:"'Poppins','DM Sans',sans-serif", fontSize:11, color:"#B8860B", fontWeight:700, letterSpacing:2 }}>⭐ {confirmed.guestType}</span>
              </div>
            )}
            <p style={{ fontFamily:"'Poppins','DM Sans',sans-serif", fontSize:12, color:"#6B6154", marginBottom:10 }}>to the</p>
            <h1 style={{ fontFamily:"'Playfair Display',serif", fontSize:32, fontWeight:900, color:"#2E2A24", lineHeight:1.05, marginBottom:4 }}>{eventInfo.title}<br /><span style={{ color:"#B8860B" }}>{eventInfo.year}</span></h1>
            <div style={{ width:55, height:1, background:"#B8860B", margin:"18px auto" }} />
            ...
            <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:"8px 20px", background:"rgba(184,134,11,0.07)", border:"1px solid rgba(184,134,11,0.3)", borderRadius:10, padding:"12px 20px", marginTop:20 }}>
              ...
              <div style={{ textAlign:"left" }}>
                <div style={{ fontFamily:"'Poppins','DM Sans',sans-serif", fontSize:9, color:"#8A7F6E", textTransform:"uppercase", letterSpacing:1.5 }}>Pax</div>
                <div style={{ fontFamily:"'Playfair Display',serif", fontSize:18, color:"#B8860B", fontWeight:700 }}>{confirmed.pax}</div>
              </div>
              {confirmed.mobile && (
                <div style={{ textAlign:"left", gridColumn:"1 / -1" }}>
                  <div style={{ fontFamily:"'Poppins','DM Sans',sans-serif", fontSize:9, color:"#8A7F6E", textTransform:"uppercase", letterSpacing:1.5 }}>Mobile</div>
                  <div style={{ fontFamily:"'Poppins','DM Sans',sans-serif", fontSize:14, color:"#3F3A34", fontWeight:600 }}>📱 {confirmed.mobile}</div>
                </div>
              )}
              {confirmed.dietary && (
                <div style={{ textAlign:"left", gridColumn:"1 / -1", borderTop:"1px solid rgba(184,134,11,0.14)", paddingTop:8, marginTop:4 }}>
                  <div style={{ fontFamily:"'Poppins','DM Sans',sans-serif", fontSize:9, color:"#8A7F6E", textTransform:"uppercase", letterSpacing:1.5 }}>Dietary</div>
                  <div style={{ fontFamily:"'Poppins','DM Sans',sans-serif", fontSize:14, color:"#3F3A34", fontWeight:600 }}>{confirmed.dietary}{confirmed.allergies ? ` · Allergy: ${confirmed.allergies}` : ""}</div>
                </div>
              )}
            </div>
            {/* QR */}
            <div style={{ marginTop:20, display:"flex", flexDirection:"column", alignItems:"center", gap:8 }}>
              <p style={{ fontFamily:"'Poppins','DM Sans',sans-serif", fontSize:10, color:"#8A7F6E", letterSpacing:2 }}>ENTRY QR CODE</p>
              ...
              <p style={{ fontFamily:"'Poppins','DM Sans',sans-serif", fontSize:9, color:"#9A8F7E", letterSpacing:2, textTransform:"uppercase" }}>Present at entrance</p>
